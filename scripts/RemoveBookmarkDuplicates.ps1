...
$parameterOrder = @('Path','Recursive','Passthru')
$configParameters = @{}
...
if ($effective.ContainsKey('Recursive') -and [bool]$effective['Recursive']) {
    $callParams['Recursive'] = $true
}
...
Remove-BookmarkDuplicates @callParams @control
